...
@section('title', 'Player Profile - ' . $user->name)

@section('main')
<div class="max-w-6xl mx-auto pb-12">
    {{-- Header --}}
    <div class="flex items-center gap-3 mb-8">
        <a href="{{ route('student.leaderboard') }}" class="text-surface-variant hover:text-primary transition-colors">
        ...
        <h1 class="font-headline text-2xl text-on-surface uppercase tracking-wider">PLAYER IDENTITY: {{ $user->name }}</h1>
    </div>
